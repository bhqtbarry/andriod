...
fun MapScreen(
    ...
    BoxWithConstraints(
        ...
        Canvas(
            ...
            drawRect(Color(0xFFDDEEFF))
            val continentColor = Color(0xFF9BBF95)
            val outline = Color(0xFF6E8D69)
            ...
            fun drawBlob(points: List<Offset>) {
                ...
                drawPath(path, color = outline, style = androidx.compose.ui.graphics.drawscope.Stroke(width = 2f))
            }
